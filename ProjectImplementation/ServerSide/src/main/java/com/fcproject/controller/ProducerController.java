...
public class ProducerController {
    ...
    public void saveProducer(   @RequestParam("file") MultipartFile file,
        ...
        newProducer.setProducerDesc(producerDesc);
        newProducer.setProducerPhone(producerPhone);
        newProducer.setProducerCity(producerCity);
        newProducer.setProducerName(producerName);
        newProducer.setProducerAddress(producerAddress);
